...
const NEWS_URL = `https://newsdata.io/api/1/news?apikey=pub_62821603e0100105f92b76bbd3e010a2bb5d5&country=in&language=en&category=technology `;
    ...
    return (
        ...
        >
            <Animated.View
                ...
                style={styles.header}
            >
                <Text style={styles.headerText}>Technology News</Text>
            </Animated.View>
